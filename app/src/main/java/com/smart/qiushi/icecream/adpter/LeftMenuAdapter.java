...
/**
 * Created by shilei on 2018/8/29
 */
public class LeftMenuAdapter extends RecyclerView.Adapter {
    ...
    public interface onItemSelectedListener {
        public void onLeftItemSelected(int postion, FoodMenu menu);
    }
    ...
    public LeftMenuAdapter(Context mContext, ArrayList<FoodMenu> mMenuList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        FoodMenu foodMenu = mMenuList.get(position);
        LeftMenuViewHolder viewHolder = (LeftMenuViewHolder) holder;
        viewHolder.menuName.setText(foodMenu.getMenuName());
    ...
    private class LeftMenuViewHolder extends RecyclerView.ViewHolder {
        ...
        public LeftMenuViewHolder(final View itemView) {
            super(itemView);
            menuName = (TextView) itemView.findViewById(R.id.tv_left_menu);
